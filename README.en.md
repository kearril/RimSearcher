...
|---|---|
| **RimSearcher.DataMod** | In-game reflection export mod. Exports the currently loaded Def data to `defs.db` at runtime; labels and descriptions use the game's current language. The in-game UI supports English, Simplified Chinese and Traditional Chinese |
...
# Output: RimSearcher_DataMod/Assemblies/RimSearcher.DataMod.dll
```
